            ...
            <div class="relative max-w-7xl mx-auto" data-id="nvxv3kn8" data-line="63-97">
                <div class="flex flex-col md:flex-row items-center" data-id="009wha9n" data-line="64-96">
                    <div class="md:w-1/2 mb-10 md:mb-0 md:pr-10" data-id="nbar8ia8" data-line="65-83">
                        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight text-gray-900 mb-4" data-id="gollvnw7" data-line="66-68">
                        ...
                        <div class="flex space-x-4" data-id="sirnjvi8" data-line="75-82">
                            <a href="#" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-primary hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary" data-id="03dm794z" data-line="76-78">
                                View My Work
                            </a>
                            <a
                    ...
                    <div class="md:w-1/2 flex justify-center" data-id="z6qthd9t" data-line="84-95">
                        <div class="relative" data-id="8x4x0oo2" data-line="85-94">
                            ...
                            <div class="absolute -bottom-4 -right-4 bg-white p-4 rounded-full shadow-lg" data-id="tqe05oyu" data-line="89-93">
                                <div class="flex items-center justify-center w-16 h-16 rounded-full bg-accent text-white" data-id="fp83jq5o" data-line="90-92">
                                    <i class="fas fa-code text-2xl" data-id="k1xt4993" data-line="91-91"></i>
                                </div>
                            </div>
                        </div>
                    </div>
